 ...
 *   ตัดเพื่อทรง V (ก.ย. 2026): วันละ 4 ท่า ~24 นาที (วันขามี 5 เพราะทดลอง Smith Bench) — เก็บเฉพาะท่าที่สร้างไหล่กว้าง ปีกกว้าง อกบน ไหล่หลัง
...
export const WEEKLY_PLAN = [
  ['ยิม 6 วัน', 'วันละ ~25 นาที ตามการ์ดด้านบน · 3 เซตใส่สุด · วันขาปิดท้ายด้วย Smith Bench'],
