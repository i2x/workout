...
- Day 3 (Legs) เป็นเครื่องล้วน ชื่อตรงกับป้ายบนเครื่อง: Leg Press · Leg Extension · Leg Curl · Calf Raise · ปิดท้ายด้วย Smith Bench Press (ทดลอง) · Triceps Pushdown · Cable Curl
- Day 1/2 ใช้เครื่อง Chest Press · Lat Pulldown เป็นหลัก
- ส่วนที่ไม่มีเครื่องเฉพาะใช้เคเบิลแทน และเขียนวิธีตั้งเครื่องกำกับไว้
  (รอกสูงเท่าไหร่ · ใส่ด้ามอะไร · ท่าทางย่อ ๆ)

**เก็บเฉพาะท่าที่ไม่มีอะไรแทนได้**
- ท่าที่ซ้ำกับท่าอื่นในวันเดียวกันถูกตัดออก
- Pec Fly เคยตัดแล้วเอากลับมา — ท่าดันอกไม่พามือเข้าชิดกลางอก เล่นแล้วโดนแต่อกด้านข้าง · อยู่ Day 2 ติดกับ Rear Delt เพราะเป็นเครื่องเดียวกัน
- Lateral Raise (ไหล่ข้าง) และ Seated Cable Row (กลางหลัง) ห้ามตัด ไม่มีท่าอื่นในตารางคุมสองส่วนนี้

**ท่าละตัวเดียว ไม่มีตัวสำรอง**
- ตัดตัวสำรองออกทั้งหมด (ก.ย. 2026) เพราะไม่เคยกดสลับ ตารางจะได้ชัดว่าวันนี้เล่นอะไร
- โค้ดยังรองรับ `options` หลายตัวอยู่ — ถ้าใส่มากกว่าหนึ่งตัว ปุ่ม "⇄ ใช้ตัวอื่นแทน" จะกลับมาเอง และประวัติยังนับรวมเป็นท่าเดียวกัน
...
```js
{
  ...
  options: [                    // ตัวแรก = ท่าหลักที่แอปขึ้นให้ · ใส่เพิ่มได้ถ้าอยากมีตัวสำรอง (ตอนนี้ใช้ตัวเดียวทุกท่า)
