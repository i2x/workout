...
- Day 3 (Legs) เป็นเครื่องล้วน ชื่อตรงกับป้ายบนเครื่อง: Leg Press · Leg Extension · Leg Curl · ปิดท้ายด้วย Smith Bench Press (ทดลอง) — น่องกับท้องทำที่บ้าน ตารางยิมเก็บเฉพาะท่าที่ต้องใช้เครื่อง
