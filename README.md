...
- Day 3 (Legs) เป็นเครื่องล้วน ชื่อตรงกับป้ายบนเครื่อง: Leg Press · Leg Extension · Leg Curl · Glute · Calf Raise
...
- ท่าที่ต้องใช้เครื่องนอกลิสต์ (Rear Delt, Preacher Curl) อยู่ในกลุ่มตัวสำรอง
...
- ท่าที่มีตัวเลือกมากกว่าหนึ่ง (ส่วนใหญ่คือ Day 1/2) กดปุ่ม "⇄ ใช้ตัวอื่นแทน" สลับได้ แล้วแอปจำไว้ให้ครั้งถัดไป
